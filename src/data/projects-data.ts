...
const projectsDB = [
  {
    ...
    myContributions: [
      ...
      "Developed reusable components and custom hooks for scalable workflows",
      ...
      "Built farmland management, booking dashboards, and profile features",
      "Worked with backend engineers on API integration and error handling",
      "Implemented responsive UI based on Figma designs and multilingual requirements",
    ],

    challenges:
      "Rendering 20,000+ farmland polygons efficiently was the biggest challenge. Early implementations caused lag during zooming and panning, so I introduced MVT (Mapbox Vector Tiles) with deck.gl and local caching strategies, improving load performance by about 40%. Supporting five languages with different character sets also required careful font handling and layout adjustments.",

    reflection:
      "This project strengthened my ability to build scalable production applications independently. I gained hands-on experience with geospatial visualization, large-scale data rendering, and frontend performance optimization while collaborating with designers, backend engineers, and product stakeholders on a real-world platform.",
